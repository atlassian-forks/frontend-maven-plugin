...
assert buildLog.contains('Installing node version v12.5.0') : 'Should trigger standard installation'

assert buildLog.contains('v12.5.0') : 'Node was not provided from the version manager'
